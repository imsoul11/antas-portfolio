...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Antas.</span> I'm a{" "}
        <span className="font-bold">full-stack developer</span>  I enjoy
        building <span className="font-bold">sites & apps.</span>
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/antasjain/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/imsoul11"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
